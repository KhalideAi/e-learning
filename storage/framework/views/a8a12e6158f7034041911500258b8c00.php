...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/Soal.css')); ?>">
    <script type="text/javascript" src="<?php echo e(asset('js/SOal.js')); ?>" defer></script>
</head>
<body>
...
<?php /**PATH /opt/lampp/htdocs/satu-quiz/resources/views/soal.blade.php ENDPATH**/ ?>