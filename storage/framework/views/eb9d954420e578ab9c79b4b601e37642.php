  ...
  <div class="gride mt-14">
      ...
      <div class="card w-96 bg-slate-50 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="card-actions justify-start">
            <a class="btn btn-default" href="soal">Kerjakan</a>
          </div>
        </div>
      </div>
      ...
      <div class="card w-96 bg-slate-50 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="card-actions justify-start">
            <a class="btn btn-default" href="soal-pkn">Kerjakan</a>
          </div>
        </div>
      </div>
      ...
      <div class="card w-96 bg-slate-50 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="card-actions justify-start">
            <a class="btn btn-default" href="soal-sejarah">Kerjakan</a>
          </div>
        </div>
      </div>
      ...
      <div class="card w-96 bg-slate-50 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="card-actions justify-start">
            <a class="btn btn-default" href="soal-metik">Kerjakan</a>
          </div>
        </div>
      </div>
      ...
      <div class="card w-96 bg-slate-50 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="card-actions justify-start">
            <a class="btn btn-default" href="soal-biologi">Kerjakan</a>
          </div>
        </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\satu-quiz\resources\views/quiz.blade.php ENDPATH**/ ?>